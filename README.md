...
A VS Code dashboard for keeping track of local <strong>Codex</strong> and <strong>Claude Code</strong> sessions - what's running, what's requesting approval, and what's already reviewed. Run `Agent Monitor: Open Dashboard` or click the robot icon in the status bar.
