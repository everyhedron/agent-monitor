...
A VS Code dashboard for keeping track of local <strong>Codex</strong> and <strong>Claude Code</strong> sessions - what's running, what's requesting approval, and what's already reviewed. Run `Agent Monitor: Open Dashboard` or click the robot <picture><source media="(prefers-color-scheme: light)" srcset="media/hubot-light.png"><source media="(prefers-color-scheme: dark)" srcset="media/hubot-dark.png"><img alt="Hubot icon" src="media/hubot-light.png" width="18"></picture> icon in the status bar.
...
<p align="center">
  <picture>
    ...
    <img alt="Agent Monitor Dashboard" src="media/dashboard-dark.png" width="100%">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <img alt="Agent Monitor Filter" src="media/statuscards-dark.png" width="80%">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <img alt="Agent Monitor Usage" src="media/usage-dark.png" width="80%">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <img alt="Agent Monitor Status" src="media/statusbar-dark.png" width="120">
  </picture>
</p>
